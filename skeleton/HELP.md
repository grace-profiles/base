...
* [Spring Boot Gradle Plugin Reference Guide](https://docs.spring.io/spring-boot/docs/3.1.12/reference/html/build-tool-plugins.html#build-tool-plugins.gradle)
* [Spring Web](https://docs.spring.io/spring-boot/docs/3.1.12/reference/html/web.html#web)
